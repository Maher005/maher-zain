          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-8 animate-slide-in-left" style={{ animationDelay: '0.3s' }}>
              ...
              <div className="flex space-x-4 pt-4 animate-fade-in" style={{ animationDelay: '1s' }}>
                <a href="https://github.com/Maher005" target='_blank' className="p-3 bg-white dark:bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  <Github className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors" size={24} />
                </a>
                <a href="https://www.linkedin.com/in/maher-zain-b69b69330/" target='_blank' className="p-3 bg-white dark:bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
